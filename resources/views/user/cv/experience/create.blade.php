        ...
        {{ csrf_field() }}
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="work-input" name="uid_work" placeholder="work" class="form-control">
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="from-input" name="from_experiences" placeholder="From Experiences" class="form-control">
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
                ...
                <div class="col-12 col-md-9">
                    <input type="date" id="date-first-input" name="date_frist_experience" placeholder="Enter Date First" class="form-control">
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
